...
metricQry += "clist=6.144.146&slist=6&options=csv"
...
metricQry += "usertoken={}&apptoken={}}&".format(userToken, appToken)
metricQry += "query={'22'.CT." + str(filter1) + "}AND{'38'.CT." + filter2 + "}&clist=148&slist=3"
response=requests.get(metricQry).content
...
metricQry += "usertoken={}&apptoken={}}&".format(userToken, appToken)
metricQry += "_fid_14={}&update_id={}".format(updVal, update_id)
requests.get(metricQry).content